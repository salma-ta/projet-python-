...
def reserver_salle_ui(parent):
    ...
    def valider():
        ...
        if not etat["salles_chargees"]:
            # Étape 1 : Vérification + Chargement des salles disponibles
            ...
            if not salles_dispo:
                ...
                messagebox.showinfo("Salles disponibles", "Sélectionnez une salle puis cliquez à nouveau sur Valider.")
        else:
            # Étape 2 : Réservation et résumé
